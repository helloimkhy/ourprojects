...
import svc.ReviewWriteProServive;
...
public class ReviewWriteProAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) {
		System.out.println("Review Write Pro Action");
...
//		System.out.println("리뷰 액션의 영화제목 : " + title);
		...
		ReviewWriteProServive service = new ReviewWriteProServive();
		
		boolean isReviewSuccess = service.insertReview(cmt);
